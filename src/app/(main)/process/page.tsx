        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-8 text-center max-w-4xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto text-balance leading-relaxed">
              Kami tidak sekadar merakit kode lalu berharap keajaiban terjadi. Kami mematuhi alur
              rekayasa (engineering flow) tingkat Enterprise agar produk akhir yang diciptakan
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-6">
            Wujudkan Ide Eksekusional Anda
          </h2>
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Jangan biarkan ide cemerlang Anda terhambat oleh proses yang berantakan. Percayakan pada
            tim rekayasa kami.
          </p>
          <Link href="/contact">
            <Button
              size="lg"
              className="gap-3 group text-lg h-14 px-8 bg-white text-black hover:bg-slate-200 border-none font-bold"
            >
