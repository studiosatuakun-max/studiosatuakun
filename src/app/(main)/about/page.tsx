        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-8 text-center max-w-4xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto text-balance leading-relaxed">
              Studio Satu Akun adalah perangkat lunak (Software Studio) premium yang berfokus
              membantu UMKM, Startup, dan Perusahaan korporasi untuk bertransformasi secara digital.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Filosofi yang mendasari setiap baris kode dan desain yang kami buat.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Kami membangun aplikasi yang ringan, cepat, dan dioptimalkan untuk performa SEO serta rasio konversi.',
              },
              {
                icon: <Target className="w-8 h-8 text-emerald-400" />,
                title: 'Business Centric',
                desc: 'Solusi teknologi dan desain kami selalu berorientasi pada pencapaian target bisnis Anda yang sesungguhnya.',
              },
              {
                icon: <Code2 className="w-8 h-8 text-blue-400" />,
                title: 'Clean Architecture',
                desc: 'Kode yang modular, rapi, dan dirancang dengan pondasi arsitektur solid untuk kemudahan maintenance jangka panjang.',
              },
              {
                icon: <Rocket className="w-8 h-8 text-rose-400" />,
                title: 'Future Proof',
                desc: 'Beradaptasi secara proaktif menggunakan teknologi modern (seperti Next.js 15 & Otomatisasi AI) demi relevansi masa depan.',
              },
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center z-10 relative">
          ...
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Mari diskusikan bagaimana teknologi dapat mempercepat pertumbuhan operasional bisnis
            Anda. Konsultasi rancangan awal selalu gratis.
          </p>
          <Link href="/contact">
            <Button
              size="lg"
              className="gap-3 group text-lg h-14 px-8 bg-yellow-400 hover:bg-yellow-500 text-slate-900 border-none font-bold"
            >
              Mulai Konsultasi
