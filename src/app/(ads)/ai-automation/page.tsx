...
export const metadata: Metadata = {
  ...
  description:
    'Otomatisasi proses bisnis menggunakan AI untuk meningkatkan produktivitas dan mengurangi biaya operasional.',
};
  ...
  return (
    <main className="min-h-screen bg-slate-950">
        ...
        headline={
          <>
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-200">
              Pekerjaan yang Bisa Dilakukan AI?
            </span>
          </>
        }
        ...
        solutions={[
          {
            ...
            description:
              'Agen AI yang mampu merespon pelanggan 24/7 dengan bahasa natural layaknya manusia.',
            icon: <MessageSquare />,
          },
          {
            title: 'AI Chatbot WhatsApp',
            description: 'Otomatisasi penjualan dan pelayanan langsung di WhatsApp pelanggan Anda.',
            icon: <Bot />,
          },
          {
            title: 'AI Knowledge Base',
            description:
              'Sistem yang bisa menjawab pertanyaan internal tim berdasarkan dokumen SOP perusahaan.',
            icon: <BookOpen />,
          },
          {
            title: 'AI Content Automation',
            description:
              'Otomatisasi pembuatan konten marketing, blog, dan deskripsi produk dalam hitungan detik.',
            icon: <PenTool />,
          },
          {
            title: 'AI Sales Assistant',
            description:
              'Asisten virtual yang membantu tim sales menganalisa leads dan menyusun penawaran.',
            icon: <TrendingUp />,
          },
          {
            title: 'Workflow Automation',
            description:
              'Hubungkan berbagai aplikasi (CRM, Email, ERP) agar berjalan otomatis tanpa campur tangan staf.',
            icon: <Network />,
          },
        ]}
      />
      ...
      <ProcessSteps
        ...
        steps={[
          {
            title: 'Konsultasi AI (Gratis)',
            description:
              'Kami mengidentifikasi proses mana yang memakan waktu paling lama di bisnis Anda.',
          },
          {
            title: 'Audit & Perancangan Workflow',
            description:
              'Membuat alur kerja bagaimana AI akan menggantikan atau membantu proses tersebut.',
          },
          {
            title: 'Pembuatan Dummy Workflow (Gratis)',
            description: 'Mendemonstrasikan cara AI bekerja untuk kasus spesifik bisnis Anda.',
          },
          {
            title: 'Integrasi & Training Model',
            description: 'Menghubungkan AI dengan data perusahaan Anda dengan keamanan tinggi.',
          },
          {
            title: 'Pelatihan Tim & Launching',
            description:
              'Mengajarkan tim Anda cara bekerja berdampingan dengan AI untuk hasil maksimal.',
          },
        ]}
      />
      ...
      <QuoteSection
        quote={
          <>
            "Perusahaan yang mengadopsi AI lebih cepat hari ini, akan memiliki{' '}
            <strong className="text-white font-bold">
              keunggulan kompetitif yang eksponensial
            </strong>{' '}
            di masa depan."
          </>
        }
