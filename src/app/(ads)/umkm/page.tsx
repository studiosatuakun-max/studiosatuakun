...
export const metadata: Metadata = {
  ...
  description:
    'Digitalisasi UMKM dengan Website Toko Online, Sistem Kasir (POS), dan Manajemen Stok. Harga terjangkau, mudah digunakan.',
};
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        solutions={[
          {
            ...
            description:
              'Buka cabang digital Anda 24 jam dengan website toko online yang bisa menerima pesanan otomatis.',
            icon: <LayoutTemplate />,
          },
          {
            title: 'Sistem Kasir (POS)',
            description:
              'Aplikasi kasir yang cepat, mudah digunakan, dan terintegrasi langsung dengan laporan penjualan harian.',
            icon: <Calculator />,
          },
          {
            title: 'Manajemen Stok Barang',
            description:
              'Pantau keluar masuk barang secara real-time. Ketahui kapan harus restock agar tidak kehabisan barang.',
            icon: <PackageCheck />,
          },
          {
            title: 'Laporan Keuangan Otomatis',
            description:
              'Laporan penjualan dan laba rugi otomatis tersusun setiap kali ada transaksi yang terjadi.',
      ...
      <ProcessSteps
        ...
        steps={[
          {
            title: 'Langkah 1: Ngobrol Santai',
            description:
              'Hubungi kami via WhatsApp, ceritakan jenis bisnis Anda (F&B, Retail, Jasa, dll).',
          },
          {
            title: 'Langkah 2: Cek Demo Sistem',
            description:
              'Kami tunjukkan demo Sistem POS & Website yang cocok untuk model bisnis Anda.',
          },
          {
            title: 'Langkah 3: Setup & Penyesuaian',
            description: 'Kami bantu setup menu, harga, dan stok barang ke dalam sistem baru Anda.',
          },
          {
            title: 'Langkah 4: Training & Mulai Jualan!',
            description: 'Sistem siap dipakai! Kami ajarkan cara pakainya ke kasir dan admin Anda.',
          },
        ]}
      />
      ...
      <QuoteSection
        ...
        quote={
          <>
            "Di era modern, UMKM yang bisa tumbuh membesar adalah UMKM yang{' '}
            <strong className="text-slate-900 font-bold">
              operasionalnya rapi, stoknya akurat, dan penjualannya mudah dipantau
            </strong>
            ."
          </>
        }
