...
export const metadata: Metadata = {
  ...
  description:
    'B2B Custom Software Development, ERP, CRM, dan sistem operasional untuk Enterprise dan Perusahaan Menengah.',
};
    ...
    <main className="min-h-screen bg-slate-950">
      ...
      <SolutionGrid
        ...
        solutions={[
          {
            title: 'ERP System',
            description: 'Sistem Perencanaan Sumber Daya Perusahaan terpusat.',
            icon: <Database />,
          },
          {
            title: 'CRM System',
            description: 'Kelola hubungan dan retensi pelanggan dengan efektif.',
            icon: <Briefcase />,
          },
          {
            title: 'Inventory Management',
            description: 'Lacak stok barang, mutasi, dan gudang secara akurat.',
            icon: <Truck />,
          },
          {
            title: 'Dashboard Monitoring',
            description: 'Visualisasi data bisnis dalam satu panel komprehensif.',
            icon: <LineChart />,
          },
          {
            title: 'HR & Payroll System',
            description: 'Otomatisasi absensi, penggajian, dan manajemen karyawan.',
            icon: <Activity />,
          },
          {
            title: 'School/Healthcare System',
            description: 'Solusi khusus untuk instansi pendidikan dan medis.',
            icon: <GraduationCap />,
          },
        ]}
      />
      ...
      <ProcessSteps
        ...
        steps={[
          {
            title: 'Fase 1: Audit & Konsultasi (Gratis)',
            description: 'Kami mempelajari alur kerja dan bottleneck di perusahaan Anda.',
          },
          {
            title: 'Fase 2: Requirement Gathering',
            description:
              'Mendokumentasikan seluruh fitur dan spesifikasi yang dibutuhkan setiap divisi.',
          },
          {
            title: 'Fase 3: Dummy Prototype (Gratis)',
            description:
              'Kami menyajikan visual antarmuka sistem sebelum Anda memutuskan berinvestasi.',
          },
          {
            title: 'Fase 4: Agile Development',
            description: 'Pengembangan sistem secara modular agar bisa digunakan secara bertahap.',
          },
          {
            title: 'Fase 5: UAT & Deployment',
            description: 'Pengujian bersama staf Anda sebelum sistem diimplementasikan sepenuhnya.',
          },
        ]}
      />
      ...
      <QuoteSection
        quote={
          <>
            "Investasi terbaik bagi sebuah perusahaan hari ini adalah{' '}
            <strong className="text-white font-bold">digitalisasi operasional</strong> yang terukur
            dan terintegrasi."
          </>
        }
      />
