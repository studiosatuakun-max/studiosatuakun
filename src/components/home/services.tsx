...
const services = [
  {
    ...
    description:
      'High-performance web applications built with Next.js and React. Scalable, secure, and SEO-optimized by default.',
  ...
  },
  {
    ...
    description:
      'Smart automation, LLM integrations, and custom AI agents built to streamline your business operations.',
  ...
  },
  {
    ...
    description:
      "Pixel-perfect, conversion-optimized interfaces that feel premium and intuitive to use. We don't just design, we engineer experiences.",
        ...
        <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-3xl">
            <h2 className="text-5xl md:text-7xl font-extrabold tracking-tighter mb-6">
              Engineering <br /> <span className="text-slate-500">Capabilities.</span>
            </h2>
          </div>
          <p className="text-muted-foreground max-w-md text-xl tracking-tight leading-relaxed">
            Comprehensive digital solutions crafted with modern tech stacks to give your business an
            unfair advantage.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 group" onMouseMove={handleMouseMove}>
