...
export function CentralHubView() {
  const nodes = [
    {
      icon: (
        <Globe className="w-10 h-10 text-blue-400 drop-shadow-[0_0_15px_rgba(96,165,250,0.8)]" />
      ),
      label: 'WEB',
      angle: 0,
      color: 'text-blue-400',
    ...
    {
      icon: (
        <Smartphone className="w-10 h-10 text-emerald-400 drop-shadow-[0_0_15px_rgba(52,211,153,0.8)]" />
      ),
      label: 'MOBILE',
      angle: 72,
    ...
    {
      icon: (
        <Database className="w-10 h-10 text-purple-400 drop-shadow-[0_0_15px_rgba(192,132,252,0.8)]" />
      ),
      label: 'DATA',
      angle: 144,
    ...
    {
      icon: (
        <Cloud className="w-10 h-10 text-sky-400 drop-shadow-[0_0_15px_rgba(56,189,248,0.8)]" />
      ),
      label: 'CLOUD',
      angle: 216,
      color: 'text-sky-400',
    ...
    {
      icon: (
        <Code className="w-10 h-10 text-rose-400 drop-shadow-[0_0_15px_rgba(251,113,133,0.8)]" />
      ),
      label: 'API',
      angle: 288,
      color: 'text-rose-400',
    ...
    >
      ...
      <div className="relative w-full max-w-3xl aspect-square flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute -bottom-8 text-xs font-bold tracking-[0.3em] text-yellow-400 drop-shadow-[0_0_5px_rgba(234,179,8,0.8)]">
            CORE
          </div>
        </motion.div>
        ...
        {nodes.map((node, i) => {
          ...
          return (
            ...
            >
              <div className="relative flex items-center justify-center">{node.icon}</div>
              <div
                className={`absolute -bottom-8 w-max text-center text-[10px] font-bold tracking-[0.2em] ${node.color} drop-shadow-[0_0_5px_currentColor]`}
              >
                {node.label}
              </div>
            </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 h-full bg-black/40 rounded-xl border border-white/5 p-4 font-mono text-xs sm:text-sm text-white/70 overflow-hidden relative shadow-inner">
        <div className="absolute top-2 left-4 text-[10px] text-white/30 uppercase tracking-widest font-sans">
          page.tsx
        </div>
      ...
      <div className="w-1/2 h-full bg-white/[0.02] rounded-xl border border-white/5 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          >
            ...
            <div className="text-xl font-bold text-emerald-400 drop-shadow-[0_0_10px_rgba(52,211,153,0.2)]">
              +12.5%
            </div>
          </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div
          className="absolute -top-[20%] -right-[10%] w-[70%] h-[70%] rounded-full bg-emerald-500/20 blur-[120px] animate-pulse"
          style={{ animationDuration: '4s' }}
        ></div>
        <div
          className="absolute top-[20%] -left-[10%] w-[60%] h-[60%] rounded-full bg-yellow-500/10 blur-[120px] animate-pulse"
      ...
      <div className="h-14 flex items-center justify-between px-8 border-b border-white/5 relative z-20 bg-black/50 backdrop-blur-md">
        <div className="font-bold text-sm tracking-tighter">
          STUDIO<span className="text-yellow-400">SATUAKUN</span>
        </div>
        ...
        <div className="px-4 py-1.5 bg-white text-black rounded-full text-[10px] font-bold">
          Contact Us
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative p-8 text-center">
        ...
        >
          <div className="px-5 py-2.5 bg-white text-black rounded-full text-[11px] font-bold">
            Start Project
          </div>
          <div className="px-5 py-2.5 border border-white/20 rounded-full text-[11px] font-bold hover:bg-white/5">
            View Work
          </div>
        </motion.div>
      </div>
      ...
      <div className="h-32 px-8 pb-8 flex gap-4">
        <motion.div
          ...
          className="flex-[2] bg-white/5 rounded-xl border border-white/10 p-4 relative overflow-hidden"
        >
          ...
          <div className="absolute right-0 bottom-0 w-32 h-16">
            ...
            >
              <path
                d="M0,50 L20,30 L40,40 L60,10 L80,20 L100,5"
                fill="none"
                stroke="#10b981"
                strokeWidth="2"
              />
        ...
        <motion.div
          ...
          className="flex-[1] bg-gradient-to-br from-yellow-500/20 to-rose-500/20 rounded-xl border border-white/10 p-4"
        >
          ...
          <div className="flex flex-col gap-1">
            {[
              ...
              <div key={i} className="flex justify-between items-center bg-white/5 rounded p-1.5">
                ...
                <div className={`text-[7px] ${t.pos ? 'text-emerald-400' : 'text-white'}`}>
                  {t.v}
                </div>
              </div>
            ))}
      ...
      {apps.map((app, i) => (
        ...
        >
          ...
          <div className="flex-1 bg-[#0a0a0a] rounded-[1.5rem] overflow-hidden flex flex-col relative z-10">
            <div
              className={`absolute top-0 inset-x-0 h-32 bg-gradient-to-b ${app.color} opacity-50 pointer-events-none`}
            ></div>
            ...
            <div className="flex-1 px-3 relative z-10">{app.content}</div>
            ...
            <div className="h-10 border-t border-white/10 bg-[#0a0a0a]/80 backdrop-blur-md flex justify-around items-center px-2 z-10">
              {[1, 2, 3, 4].map((idx) => (
                <div
                  key={idx}
                  className={`w-3 h-3 rounded-full ${idx === 1 ? 'bg-white/80' : 'bg-white/20'}`}
                ></div>
              ))}
            </div>
          </div>
...
export function SoftwareView() {
  return (
    ...
    >
      {/* Matrix Text */}
      <div
        className="absolute inset-0 overflow-hidden pointer-events-none opacity-[0.03] text-[10px] font-mono text-emerald-500 whitespace-pre leading-none break-all z-0"
        style={{ writingMode: 'vertical-rl' }}
      >
        {Array.from({ length: 40 })
          .map(() =>
            '01010011 01000001 01010100 01010101 01000001 01001011 01010101 01001110 '.repeat(20)
          )
          .join('\n')}
      </div>
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="w-40 border-r border-white/10 bg-[#0c0c0c] flex flex-col">
          <div className="px-3 py-2 text-[8px] font-bold text-white/40 uppercase tracking-wider">
            Explorer
          </div>
        ...
        <div className="w-48 border-l border-white/10 bg-[#0c0c0c] flex flex-col">
          <div className="px-3 py-2 text-[8px] font-bold text-white/40 uppercase tracking-wider border-b border-white/10">
            Terminal
          </div>
