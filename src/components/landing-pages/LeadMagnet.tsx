...
export function LeadMagnet({
  ...
  subheadline,
  ctaText,
  ctaLink = 'https://wa.me/6282260880878',
  theme = 'dark',
}: LeadMagnetProps) {
      ...
      <div className="container mx-auto px-4 sm:px-8 max-w-5xl">
        <motion.div
          className={`relative rounded-3xl overflow-hidden p-8 md:p-16 text-center ${
            isLight ? 'bg-slate-900 text-white' : 'bg-slate-900 border border-white/10'
          }`}
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-10 text-balance">{subheadline}</p>
            <Link href={ctaLink} target="_blank" rel="noopener noreferrer">
              <Button
                size="lg"
                className="w-full sm:w-auto gap-3 group text-xl tracking-wide bg-yellow-400 hover:bg-yellow-500 text-slate-900 border-none"
              >
                {ctaText}
