...
const portfolioData = [
  ...
  },
  {
    ...
    category: 'SaaS',
    description:
      'SaaS Digital Invitation Generator untuk pembuatan undangan interaktif yang elegan.',
                ...
                <div className="h-56 w-full bg-[#111] rounded-t-xl border border-white/10 border-b-0 overflow-hidden relative">
                  ...
                  <div className="h-8 bg-[#0a0a0a] border-b border-white/10 flex items-center px-4 gap-2 relative z-10">
                    <div className="flex gap-1.5">
                      ...
                      <div
                        className="w-2 h-2 rounded-full bg-yellow-500/80 shadow-[0_0_8px_rgba(234,179,8,0.6)] animate-pulse"
                        style={{ animationDelay: '200ms' }}
                      ></div>
                      <div
                        className="w-2 h-2 rounded-full bg-green-500/80 shadow-[0_0_8px_rgba(34,197,94,0.6)] animate-pulse"
